...
export const WhatsIcon = ({ size=22, ...props }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...props}>
    ...
    <path d="M8 9.5c.3 3 3.5 5.6 5.8 5.8.6.06 1.3-.1 1.5-.6l.5-1.1c.1-.3 0-.6-.2-.8l-1-.7c-.2-.2-.5-.2-.8-.1l-.7.3a.9.9 0 01-.9-.2l-1.6-1.6a.9.9 0 01-.2-.9l.3-.7c.1-.3 0-.6-.1-.8l-.7-1c-.2-.2-.5-.3-.8-.2l-1.1.5c-.5.2-.7.9-.6 1.5z" fill="white" />
  </svg>
);
