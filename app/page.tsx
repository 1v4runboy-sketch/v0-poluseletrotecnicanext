  ...
  return (
    <div className="w-full">
      ...
      <section className="hero-cinema">
        ...
        {/* Estilos escopados (cinematográficos) */}
        <style jsx>{`
          .hero-cinema {
            position: relative;
            ...
            width: 100%;
            overflow: hidden;
            background: var(--hero-fade, #ffffff);
            isolation: isolate;
          }
          .hero-media {
            position: absolute;
            ...
            height: 100%;
            object-fit: cover;
            transform: scale(1.02); /* leve crop para o fade das bordas */
          ...
          /* Vignette escura (topo 40–50%, centro 10–15%, base 60–70%) */
          .vignette {
            background:
          ...
          /* Fade dinâmico (dissolve para a base) */
          .fade {
            background: linear-gradient(to bottom,
              rgba(0,0,0,0) 0%,
              var(--hero-fade, #ffffff) 92%,
              var(--hero-fade, #ffffff) 100%
            );
          }
          .hero-contents {
            position: relative;
          ...
          .line1 {
            ...
            letter-spacing: 0.22em; /* 0.18–0.25em */
            font-weight: 500;
            font-size: clamp(14px, 2.6vh, 18px);
            opacity: 0;
            transform: translateY(10px);
            animation: fadeUp 0.75s ease forwards 0.10s;
            text-shadow: 0 2px 10px rgba(0,0,0,0.45);
          }
          .line2 {
            text-transform: uppercase;
            letter-spacing: 0.06em; /* 0.04–0.08em */
            font-weight: 700;
            font-size: clamp(28px, 6.4vh, 64px);
            line-height: 1.05;
            opacity: 0;
            transform: translateY(12px);
            animation: fadeUp 0.8s ease forwards 0.20s, microGlow 1.8s ease 0.9s 1;
            text-shadow:
          ...
          .hero-hairline {
            ...
            width: 140px;
            margin-top: 14px;
            background: var(--hairline, rgba(255,255,255,0.6));
            transform-origin: left center;
            transform: scaleX(0);
            opacity: 0.9;
            animation: wipe 0.9s ease forwards 0.55s;
      ...
      {/* === MARCAS QUE TRABALHAMOS (estilo premium) === */}
